...
export default class Form extends Component {
  ...
  getStateFromProps(props, inputFormData) {
    ...
    const formData = getDefaultFormState(schema, inputFormData, rootSchema, false, this.props.onRetrieveSchema);
    const retrievedSchema = retrieveSchema(schema, rootSchema, formData, this.props.onRetrieveSchema);
  ...
  validate(
    ...
    const resolvedSchema = retrieveSchema(schema, rootSchema, formData, this.props.onRetrieveSchema);
    ...
    return (
      <FormTag
        ...
        <_SchemaField
          ...
          disabled={disabled}
          readonly={readonly}
          onRetrieveSchema={onRetrieveSchema}
        />
